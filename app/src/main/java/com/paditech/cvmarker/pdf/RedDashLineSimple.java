 ...
 */
public class RedDashLineSimple {

    private static final BaseColor THEME_COLOR = new BaseColor(171,19,47);
    ...
    private static final Font TITLE_TEXT_BOLD = new Font(FontUtil.arialFont(), 25, Font.BOLD, new BaseColor(171,19,47));
    private static final Font FIRST_NAME_TEXT_BOLD = new Font(FontUtil.arialFont(), 25, Font.BOLD, new BaseColor(171,19,47));

    private Context context;
    private Resume resume;

    public RedDashLineSimple(Context context, Resume resume) {
    ...
    public void addContent(Document document) {
        ...
        PdfPCell lineHead = new PdfPCell();
        lineHead.setFixedHeight(10);
        lineHead.setBackgroundColor(THEME_COLOR);
        lineHead.setBorder(Rectangle.NO_BORDER);
        table.addCell(lineHead);
        try {
    ...
    public void addPersonal(Document document) {
        ...
        float[] columnWidths = new float[] {20f, 20f, 60f};
        try {
        ...
        c.addElement(PDFUtils.addBlankLine());
        c.setColspan(3);
        table.addCell(c);
        ...
        image.scaleToFit(new Rectangle(60,80));
        image.setAlignment(Element.ALIGN_LEFT);

        PdfPCell c1 = new PdfPCell();
        c1.setBorder(Rectangle.NO_BORDER);
        c1.addElement(PDFUtils.addBlankLine());
        c1.addElement(image);
        table.addCell(c1);
