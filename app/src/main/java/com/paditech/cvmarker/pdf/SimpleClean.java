...
public class SimpleClean {
    ...
    private static final Font HEADER_TEXT_BOLD = new Font(FontUtil.arialFont(), 12, Font.BOLD);
    private static final Font TITLE_TEXT_BOLD = new Font(FontUtil.arialFont(), 25, Font.BOLD);


    private Context context;
    private Resume resume;

    public SimpleClean(Context context, Resume resume) {
